...
if (next && !next.dataset.bound) {
  ...
  next.addEventListener("click", (e) => {
    ...
    fillBoxData(container, box, targetBoxId) {
        ...
        console.log('starting filling', box.id, targetBoxId)
...
//   console.log('b', box.id, box.badge1, badgesContainer)
  ...
  const badges = [box.badge1, box.badge2]
...
renderBadges(box);
  ...
  style.textContent = `
    ...
    .tab-text-dark, .tab-text-dark * { color: #333333 !important; }
...
// Инициализация CMS
const cms = new FramerCMS('https://test.feedlyai.ru/');
